export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	giovanna: {
		...
		baseForme: "Soccer",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 90, atk: 100, def: 95, spa: 24, spd: 130, spe: 95},
		abilities: {0: "Sport Change"},
		heightm: 1.3,
		weightkg: 48.8,
		color: "Red",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Giovanna-Handball"],
		formeOrder: ["Giovanna", "Giovanna-Handball"],
		gen: 9,
	},
	giovannahandball: {
		num: -694,
		...
		forme: "Handball",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 90, atk: 24, def: 130, spa: 100, spd: 95, spe: 95},
		abilities: {0: "Sport Change"},
		heightm: 1.3,
		weightkg: 48.8,
		color: "Red",
