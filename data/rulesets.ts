...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standardcs: {
		effectType: 'ValidatorRule',
		name: 'Standard CS',
		desc: "The standard ruleset for all CS tier",
		ruleset: [
			'+COU', 'Obtainable', '+Unobtainable', '+Past', 'Sketch Post-Gen 7 Moves', 'Team Preview', 'Nickname Clause', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause',
		],
		unbanlist: ['Adamant Crystal', 'Griseous Core', 'Lustrous Globe', 'Bleakwind Storm', 'Lunar Blessing', 'Mystical Power', 'Sandsear Storm', 'Wildbolt Storm'],
		onValidateSet(set) {
			const species = this.dex.species.get(set.species);
